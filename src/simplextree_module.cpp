...
RCPP_MODULE(simplex_tree_module) {
  ...
  Rcpp::class_<SimplexTree>("SimplexTree")
    ...
    .method( "straverse", (SEXP (SimplexTree::*)(Function, std::string))(&SimplexTree::straverse))
    .method( "straverse", (SEXP (SimplexTree::*)(SEXP, Function, std::string))(&SimplexTree::straverse))
    .method( "straverse", (SEXP (SimplexTree::*)(SEXP, Function, std::string, Rcpp::Nullable<List>))(&SimplexTree::straverse))
