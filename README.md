...
<a id="#insert">#</a> _SimplexTree_ $ **insert**(\[*simplices*\])
...
<a id="#remove">#</a> _SimplexTree_ $ **remove**(\[*simplices*\])
...
<a id="#contract">#</a> _SimplexTree_ $ **contract**(\[*a, b*\])
...
<a id="#collapse">#</a> _SimplexTree_ $ **collapse**(...)
...
<a id="#expand">#</a> _SimplexTree_ $ **expand**(_k_)
...
<a id="#as_XPtr">#</a> _SimplexTree_ $ **as_XPtr**()
...
<a id="#print_tree">#</a> _SimplexTree_ $ **print_tree**()
...
<a id="#find">#</a> _SimplexTree_ $ **find**(\[*simplices*\])
...
<a id="#traverse">#</a> _SimplexTree_ $ **traverse** <br /> 
...
<a id="#ltraverse">#</a> _SimplexTree_ $ **ltraverse**(...)
...
<a id="#cofaces">#</a> _type_ = "**cofaces**" or _type_ = "**star**"
...
<a id="#skeleton">#</a> _type_ = "**skeleton**"
...
<a id="#maximal-skeleton">#</a> _type_ = "**maximal-skeleton**"
...
<a id="#serialize">#</a> _SimplexTree_ $ **serialize**()
...
<a id="#deserialize">#</a> _SimplexTree_ $ **deserialize**()

Deserializes a list of simplices by successively inserting them into the simplex tree.

<a id="#save">#</a> _SimplexTree_ $ **save**(_filename_)
...
<a id="#load">#</a> _SimplexTree_ $ **load**(_filename_)
...
<a id="#as_list">#</a> _SimplexTree_ $ **as\_list**()

Converts the simplex tree to list of _(n x k)_ matrices, where each matrix represents the set of _k-1_ simplices.

<a id="#as_edge_list">#</a> _SimplexTree_ $ **as\_edge_list**()

Converts the 1-skeleton to an edge list. 

<a id="#as_adjacency_list">#</a> _SimplexTree_ $ **as\_adjacency_list**()

Converts the 1-skeleton to an adjacency list. 

<a id="#as_adjacency_matrix">#</a> _SimplexTree_ $ **as\_adjacency_matrix**()
