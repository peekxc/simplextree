...
bench_preorder <- function(stree) {
    .Call(`_simplextree_bench_preorder`, stree)
}

bench_levelorder <- function(stree) {
    .Call(`_simplextree_bench_levelorder`, stree)
}

cech_complex <- function(stx, k, seb_f) {
    invisible(.Call(`_simplextree_cech_complex`, stx, k, seb_f))
}
